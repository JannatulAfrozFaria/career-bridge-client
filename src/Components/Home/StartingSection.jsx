    ...
    return (
        <div className="text-center mx-10 md:mx-auto lg:mx-auto">
            {/* <motion.div variants={fadeIn("up", 0.2)} initial= "hidden" whileInView={"show"} viewport={{once:false,amount: 0.7}} >
                <h2  className="text-4xl font-bold my-7 md:my-7 lg:my-10 text-sky-500">How We Started</h2>
            </motion.div> */}
            <div className="flex gap-8 w-5/6 mx-auto">
                <motion.div 
                 ...
                 variants={fadeLeft("left", 0.2)} initial= "hidden" whileInView={"show"} viewport={{once:false,amount: 0.3}} 
                  className='w-1/2'>
                    ...
                    <div className='w-full text-left'>
                        <Link to='/register' ><button className='btn basic-btn w-1/5 rounded-xl '>Join Us!</button></Link>
                    </div>
                 </motion.div>
            </div>
        </div>
